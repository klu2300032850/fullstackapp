pipeline {
    ...
    environment {
        ...
        TOMCAT_URL = 'http://54.166.153.193:9090/manager/text'
        TOMCAT_USER = 'admin'
        TOMCAT_PASS = 'admin'
    ...
    post {
        success {
            echo "✅ Backend deployed: http://54.166.153.193:9090/springapp1"
            echo "✅ Frontend deployed: http://54.166.153.193:9090/frontapp1"
        }
        failure {
